...
/*
    Description:This is a turn-based game that lets you choose your own equipment and the opponent will choose their eqipment randomly. 
                You will take turns choosing an action and whoever dies first loses.
    Programmed by: Abram Aki R. Bukuhan
    Last modified: Novemver 27, 2023
    Version: 2.1

    Legend:
        stat/s = statistic or data. example: HP of P1
        P1 = Player 1 or You
        P2 = Player 2 or The Opponent
*/
...
/*
    This function is to create any non-positive integer into 0.
    Precondition: The value given should be an integer.
    @param x is an integer.
    @return the same value if positive and return 0 if negative.
*/
int zero(int x){
...
/*
    This will be the main brain of the code. This is where the player and the opponent chooses their action, changes the stat due to their action, and this is where the program
    checks what to do if P1 did this action and P2 did this action.
    Precondition: All Values should be a positive integer.
    @param nP1hp is the HEALTH of Player 1.
    @param nP1atk is the ATTACK of Player 1.
    @param nP1def is the DEFENSE of Player 1.
    @param nP1spd is the SPEED of Player 1.
    @param nP1Cr is the CRITICAL RATE of Player 1.
    @param nP2hp is the HEALTH of Player 2.
    @param nP2atk is the ATTACK of Player 2.
    @param nP2def is the DEFENSE of Player 2.
    @param nP2spd is the SPEED of Player 2.
    @param nP2Cr is the CRIT RATE of Player 2.
*/
void battlePhase(int* nP1hp,int* nP1atk, int* nP1def, int* nP1spd, int* nP1Cr , int* nP2hp, int* nP2atk, int* nP2def, int* nP2spd,int* nP2Cr){
    ...
    // Loops while P1 HP or P2 HP is greater than 0 or A tie did not happen yet.
    while(*nP1hp >= 0 || *nP2hp >= 0 || ntie == 1){
        ...
        */
        ...
        // Checks if P1 hits a Crit or not
        if(nP1CrChck <= *nP1Cr){
            nP1CritHit = 1;
            nP1Dmg = *nP1atk;
        }
        ...
        // Checks if P2 hits a Crit or not
        if(nP2CrChck <= *nP2Cr){
            nP2CritHit = 1;
            nP2Dmg = *nP2atk;
        }
        ...
        // Changes the Damage to only be a 0 or a positive integer.
        nP1Dmg = zero(nP1Dmg);
        nP2Dmg = zero(nP2Dmg);
        ...
        */
        ...
        // If P1 chooses to Charge and P2 Chooses to Block
        ...
        // If P1 chooses to Block and P2 Chooses to Charge
        ...
        // If P1 chooses to Attack and P2 Chooses to Block
        ...
        // If P1 chooses to Block and P2 Chooses to Attack
        ...
        // If P1 and P2 chooses to Attack
        ...
        // If P1 and P2 Chooses to Charge
        else if(nP1Action == 2 && nP2Action == 2){
            printf("Both charged for the next turn!\n");
            nP1Chrg = 1;
            nP2Chrg = 1;
        }
        // If P1 chooses to Attack and P2 Chooses to Charge
        ...
        // If P1 chooses to Charge and P2 Chooses to Attack
...
/*
    This Function checks if the value is positive and returns it. If not, it prompts the user to try another input.
    Precondition: nVal is an integer to not create infinite loops.
    @param nVal is an integer that will be checked if it is positive or negative.
    @return the value back if it is positive.
*/
int getPos(int nVal){
    int nCheck = 0;
...
void equipPhase(){
    ...
    // Lets you choose your Equipment.
    printf("\n\nEquipments: \n\n");
    ...
    // Opponent chooses randomly for their weapon.
    switch(nWRand){
        case 1:
            nP2atk = nP2atk + 15;
            nP2spd = nP2spd + 3;
    ...
    // Opponent chooses randomly for their equipment.
    switch(nERand){
        case 1:
            nP2def = nP2def + 3;
            nP2spd = nP2spd + 3;
...
/*
    This function is for the main menu of the program/game. It lets you choose between Normal Mode, Developer Mode, or Exit. 
*/
void displayMenu(){
    int nCase;
    int nChecker = 1;
